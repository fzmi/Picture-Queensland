...
<nav class="event-nav">
    ...
    <!-- php different -->
    <a href="../gold-rush.php" id="event-nav-close" title="Exit event"><img src="../images/icons/delete-icon.png" alt="Close"></a>
</nav>

<section id="story">
    <h3>Stories</h3>
    <p>You currently have no stories. Go explore the images to collect them!<br>
    <a href="../images/stories/gold-rush-hint.png" target="_blank"><u>(Hi visitors! Here is the hint of 3 map pins which contain the stories.<br>
